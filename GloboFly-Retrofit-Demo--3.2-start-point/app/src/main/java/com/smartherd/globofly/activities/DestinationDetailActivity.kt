...
class DestinationDetailActivity : AppCompatActivity() {
    ...
    private fun loadDetails(id: Int) {
        ...
        val destionationService = ServiceBuilder.buildService(DestinationService::class.java)
        val requestCall = destionationService.getDestination(id)
        requestCall.enqueue(object : Callback<Destination> {
            ...
            override fun onResponse(call: Call<Destination>, response: Response<Destination>) {
                ...
                override fun onFailure(call: Call<Destination>, t: Throwable) {
                    Toast.makeText(this@DestinationDetailActivity,"Failed to retrive details",Toast.LENGTH_LONG).show()
                }
